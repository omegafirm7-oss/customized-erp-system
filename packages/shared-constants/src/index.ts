...
export const PERMISSIONS = {
  ...
  PURCHASE_REQUISITION_MANAGE: "procurement.requisition.manage",
  PURCHASE_REQUISITION_VIEW: "procurement.requisition.view",
  PURCHASE_REQUISITION_APPROVE: "procurement.requisition.approve",
  GOODS_RECEIPT_MANAGE: "procurement.goods-receipt.manage",
  GOODS_RECEIPT_VIEW: "procurement.goods-receipt.view",
  GOODS_RECEIPT_QC: "procurement.goods-receipt.qc",
