...
import { HiredEquipmentContractStatus } from "@prisma/client";
...
import {
  ...
  UpdateContractDto,
  UpsertEntryDto,
} from "./dto/hired-equipment.dtos";

// JwtAuthGuard + PermissionsGuard are registered globally in AppModule.
@ApiTags("hired-equipment")
@ApiBearerAuth()
@Controller("hired-equipment")
export class HiredEquipmentController {
  constructor(
  ...
  @Get("contracts")
  @Permissions(PERMISSIONS.HIRED_EQUIPMENT_CONTRACT_VIEW)
  async listContracts(
    @CurrentCompanyId() companyId: string,
    @Query("status") status?: HiredEquipmentContractStatus,
    @Query("projectId") projectId?: string,
  ) {
    return this.contractsService.list(companyId, status, projectId);
  }
  ...
  @Post("contracts")
  @Permissions(PERMISSIONS.HIRED_EQUIPMENT_CONTRACT_MANAGE)
  ...
  @Permissions(PERMISSIONS.HIRED_EQUIPMENT_TIMESHEET_MANAGE)
  ...
  @Permissions(PERMISSIONS.HIRED_EQUIPMENT_BILLING_GENERATE)
